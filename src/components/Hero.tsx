...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-20 flex items-center bg-gradient-to-r from-secondary to-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 py-12">
        <div className="max-w-3xl">
          ...
          >
            <p className="text-lg md:text-xl text-light/90 mb-8">
          ...
          >
            <Link href="#servicos" className="bg-primary hover:bg-primary-dark text-white font-medium py-3 px-6 rounded-full flex items-center justify-center transition duration-300 ease-in-out">
              Conheça nossos serviços
              <FiChevronRight className="ml-2" />
            </Link>
            
            <Link href="#agendar" className="bg-transparent hover:bg-light/10 text-light border border-light/30 font-medium py-3 px-6 rounded-full flex items-center justify-center transition duration-300 ease-in-out">
